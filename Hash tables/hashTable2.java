...
public class hashTable2 {
    ...
    public hashTable2(String file, Integer modulo) {
        this.mod = modulo;
        bucket = new Node[mod];
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // to insert the node in the bucket
    ...
    private void insert(Node newNode){
        ...
        while(bucket[index%mod] != null){ // index%mod to avoid falling out of the array edge
           index++;
        }
        bucket[index%mod] = newNode;
    ...
    public String lookup(Integer code){
        ...
        while(bucket[index] != null){
            comparison++;
            if(code.equals(bucket[index].code)){
                found = bucket[index].name;
                break;
            }
            index++;
        }
    ...
    public static void main(String[] args){
        hashTable2 ht = new hashTable2("postnummer.csv", 11587);
